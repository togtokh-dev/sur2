                                          ...
                                          <div class="modal-body">
                                              <div class="email-right-box">
                        											<div class="compose-content">
                        													...
                        													<div class="mb-3">
                        														<input type="text" name="class_name" class="form-control bg-transparent" placeholder="Нэр">
                        													</div>
                                      ...
                                      <tbody>
                                        ...
                                        ?>
                                          <tr>
                                              ...
                                              <td><a class="text-success" href="./admin-class-ed.php?id=<?php print_r($row['class_id']); ?>" target="_blank"> <?php print_r($row['class_id']); ?></a></td>
