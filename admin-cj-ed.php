    ...
    <div id="main-wrapper">
      ...
      <div class="content-body">
          ...
          <div class="row page-titles">
            <ol class="breadcrumb">
              <li class="breadcrumb-item active"><a href="javascript:void(0)"><?php echo $results['cj_name']; ?></a></li>
            </ol>
                  </div>
                      ...
                      <div class="col-lg-12">
                          <div class="card">
                             ...
                             <div class="row spno">
                              <form class="tab-pane fade active show" action="update.php" id="form" method="post"  enctype="multipart/form-data">
                                <input type="text" name="cj_id" value="<?php echo $results['cj_id'];  ?>" hidden>
                        					<div class="form-group">
                        						<label for="title">Нэр</label>
                        						<input type="text" name="cj_name" class="form-control" value="<?php echo $results['cj_name'];  ?>" >
                        					</div>
                                  <div class="form-group">
        														<label for="exampleFormControlFile1">Зөвхөн зураг...</label>
        														<input id="imageFile_img" name="cj_image" type="file" class="form-control-file" accept="image/*">
                                    <input type="text" name="cj_image" value="<?php echo $results['cj_image'];  ?>" hidden>
        													</div>
                                  <img src="<?php echo $results['cj_image'];  ?>" id="preview_img" class="img-fluid m-5 " width="100">
                                     <div class="form-group">
                                       <button type="submit" name="update_class_subject" class="btn btn-success">Шинэчилэх</button>
                                    </div>
                                </form>
                                </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="card-title">Сэдэвүүд</h4>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Сэдэв нэмэх</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="compose-content">
                                                    <div class="mb-3">
                                                      <input type="text" name="lesson_name" class="form-control bg-transparent" placeholder="Нэр">
                                                      <input type="text" name="class_id" value="<?php echo $results['class_id'];  ?>"  hidden>
                                                      <input type="text" name="cj_id" value="<?php echo $id; ?>"  hidden>
                                                    </div>
                                                </div>
                                              </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive recentOrderTable">
                                    <table class="table verticle-middle table-responsive-md">
                                        ...
                                        <tbody>
                                          <?php
                                          $resultss = mysqli_query($db, "SELECT * FROM lesson where cj_id = '$id'");
                                          $count=0;
                                          ...
                                          <?php $count++; ?>
                                            <tr>
                                                <td><?php echo $count; ?></td>
											                         	<td> <a href="admin-lesson-ed.php?id=<?php echo $row['lesson_id']; ?>" target="_blank"><img src="<?php print_r($row['lesson_image']); ?>" alt="" width="100"><?php print_r($row['lesson_id']); ?></a> </td>
                                                <td><?php print_r($row['lesson_name']); ?></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
